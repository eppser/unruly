...
commit: `9c56cca` (MODIFIED (results describe uncommitted code))
go: `go1.26.0`
...
| `08-rate-limited` | relation-discovery | n/a | n/a | `api_tokens`, `audit_events`, `customers`, `employee_records` +7 more | — |
| `08-rate-limited` | read-exposure | n/a | n/a | — | — |
| `08-rate-limited` | write-exposure | n/a | n/a | `support_tickets` | — |
| `08-rate-limited` | protected-not-flagged | n/a | n/a | — | `user_credentials` |
